/**
 * Birthday Party Planner — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'PartyPlanner', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'ActivityExpert', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'BudgetBoss', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
