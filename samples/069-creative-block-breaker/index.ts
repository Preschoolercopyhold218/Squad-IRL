/**
 * Creative Block Breaker — Squad SDK Sample
 *
...
const AGENTS = [
  { name: 'Muse', role: 'developer' as AgentRole, promptFile: 'agents/writer.md' },
  { name: 'PromptGenerator', role: 'tester' as AgentRole, promptFile: 'agents/grader.md' },
  { name: 'ConfidenceBuilder', role: 'developer' as AgentRole, promptFile: 'agents/updater.md' },
];
